...
```{r}
mat1 = cbind(c(2,4,8,6), c(1,3,7,7), c(1,3,9,9), c(0,1,5,8))
print(mat1)
myLU(mat1)
```
...
You get the identity matrix as the other matrix and the input returned if you input a lower triangular or an upper triangular matrix (upper = upper an ident, lower = lower and ident).
...
```{r}
L1 = cbind(c(1, 2, 3, 4), c(0, 1, 2, 3), c(0, 0, 1, 2), c(0, 0, 0, 1))
U1 = cbind( c(4, 5, 2, 5), c(3, 4, 4, 2),c(2, 3, 5, 4), c(4, 3, 2, 1) )
A = L1*U1
print(A)
...
I did not get the same LU matricies back.
